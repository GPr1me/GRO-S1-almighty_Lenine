...
#include <Stream.h>
#include <QTRSensors.h>// librairie pour suiveur de ligne
...
QTRSensorsAnalog qtr((unsigned char[]) {0, 1, 2, 3, 4, 5, 6, 7}, (unsigned char)8, (unsigned char)4, (unsigned char)QTR_NO_EMITTER_PIN);
/* ****************************************************************************
